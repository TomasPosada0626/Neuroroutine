...
import type { DashboardWidgetId } from './dashboardPrefsStore'
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <div className={cn('text-sm font-medium', hidden ? 'opacity-60' : 'opacity-100')}>{title}</div>
      </div>
...
export function WidgetOrderEditor({ isDay, order, hidden, titleForId, onOrderChange, onToggleHidden, footer }: Props) {
