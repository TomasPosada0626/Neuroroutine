        ...
        >
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <div className={cn('mt-0.5 text-xs', subtleText)}>
                Puedes agregar todas las que quieras. Fecha/hora son opcionales.
              </div>
            </div>
            <Button
              variant="secondary"
          ...
          <div className="mt-3 space-y-3">
            {tasks.map((t, idx) => (
              <div
                ...
                className={cn(
                  'rounded-lg p-3 ring-1',
                  isDay ? 'bg-white ring-slate-200' : 'bg-slate-950/20 ring-white/10',
                )}
              >
                <div className="grid gap-3 md:grid-cols-12">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setTasks((prev) =>
                          prev.map((x, i) => (i === idx ? { ...x, due_time: e.target.value } : x)),
                        )
                      }
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          isDay
                            ? 'text-slate-700'
                            : 'text-slate-200 focus-visible:ring-offset-slate-950',
                        )}
