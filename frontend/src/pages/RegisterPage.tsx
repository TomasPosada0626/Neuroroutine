      ...
      <Card className="mx-auto w-full max-w-md bg-white/5 p-5 ring-1 ring-white/10">
        <form className="space-y-4" onSubmit={onSubmit}>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div className="space-y-1">
              <label className="text-sm font-medium text-slate-200">Apellidos</label>
              <Input
          ...
          <div className="space-y-1">
            <label className="text-sm font-medium text-slate-200">Nombre de usuario</label>
            <Input
            ...
            <div className="text-xs text-slate-400">Lo usarás para iniciar sesión (también puedes usar email).</div>
          </div>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div className="space-y-1">
              <label className="text-sm font-medium text-slate-200">Confirmar</label>
              <PasswordInput
                autoComplete="new-password"
                className="bg-slate-950/40 text-white ring-1 ring-white/10 placeholder:text-slate-400 focus:ring-cyan-400/40"
                toggleClassName="text-slate-200 hover:bg-white/10 focus:ring-white/30"
